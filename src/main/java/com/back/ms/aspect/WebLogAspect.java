...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.back.ms.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        if(shiroUser != null) {
            String nickName=shiroUser.nickName;
            sysLog.setUsername(StringUtils.isNotBlank(nickName) ? nickName : shiroUser.loginName);
        }
    }
