    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                ...
                <button type="button" class="layui-btn layui-btn-normal" id="test2"><i class="layui-icon"></i>上传头像照片</button>
                <img <#if site.authorIcon??> src="${site.authorIcon}" <#else> src="${base}/static/images/eports-logo.png" </#if> class="layui-circle" id="userFace" style="width: 100px;height: 100px">
            </td>
            <td>authorIcon</td>
        </tr>
        <tr>
