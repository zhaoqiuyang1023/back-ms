...
<#macro bpTree children>
    <#if children?? && children?size gt 0>
        <#list children as child>
            ...
            <li style="margin-top: 5px;margin-left: 1.5em"><input type="checkbox" title="${child.name}"
                                                                  value="${child.id}"
                                                                  data-parentIds="${child.parentIds}"
                                                                  lay-filter="roleMenu"
...
<form class="layui-form">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block" style="width: 80%">
            <input type="text" class="layui-input" name="name" style="margin-top: 30px;" value="${role.name}"
    ...
    <div class="layui-form-item layui-form-text">
        <div class="layui-input-block" style="width: 80%">
            <textarea placeholder="" name="remarks" class="layui-textarea">${role.remarks}</textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;margin-left: 10px;">
            ...
            <#list menuList as menu>
                <div class="layui-inline">
                    <fieldset class="layui-elem-field">
                        <legend><input type="checkbox" value="${menu.id}" data-parentIds="${menu.parentIds}"
                                       title="${menu.name}" lay-filter="roleMenu"
                                       <#if menuIds?contains('|'+menu.id?string+'|')>checked</#if> /></legend>
