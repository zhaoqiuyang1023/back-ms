...
<div class="login">
    ...
    <form class="layui-form" action="${base}/login/main" method="post">
        ...
        <div class="layui-form-item form_code">
            <input class="layui-input" name="code" value="1111" placeholder="验证码" lay-verify="required" type="text" autocomplete="off">
        ...
        <div class="layui-form-item">
            <fieldset class="layui-elem-field">
                <div class="layui-field-box" style="color: #555555;font-size: 20px;">
                    用户名:test &nbsp;&nbsp;&nbsp;密码:1
                </div>
            </fieldset>
        </div>
