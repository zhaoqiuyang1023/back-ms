...
<head>
    ...
    <link href="${base}/static/images/eports-logo.png" rel="icon" type="image/x-icon">
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" pc>
                    <a href="javascript:">
                        <img src="<#if (currentUser.icon??)>${currentUser.icon}<#else>${base}/static/images/eports-logo.png</#if>" class="layui-circle" width="35" height="35">
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="<#if (currentUser.icon??)>${currentUser.icon}<#else>${base}/static/images/eports-logo.png</#if>"></a>
    ...
    <div class="layui-footer footer">
        <p> <a href="http://www.e-ports.com" target="_blank">e-ports</a></p>
    </div>
</div>
<script>
    var baseUrl = "${base}";
