...
<form class="layui-form" action="" lay-filter="example">
    ...
    <input name="groupId" value="${image.groupId}"  class="layui-input"
           lay-verify="title" style="display: none">

    <input name="id" value="${image.id}"  class="layui-input"
           lay-verify="title" style="display: none">

    <div class="layui-form-item">
        <div class="layui-input-block">
           <img style="width: 250px;height: 250px" id="image" src="${image.url}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="name" class="layui-input" type="text" placeholder="图片名称" autocomplete="off" value="${image.name}"
                   >
        </div>
    </div>
