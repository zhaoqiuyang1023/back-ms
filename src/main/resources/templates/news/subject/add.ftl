...
<form class="layui-form" style="width:80%;">
    ...
    <div>
        <div style="float: left">
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <img id="headImage" width="200px" height="200px" data-headimage='${subject.headImage}'>
                </div>
            </div>
        ...
        <div>
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <img id="themeImage" width="200px" height="200px" data-themeimage='${subject.themeImage}'>
                </div>
            </div>
    ...
    <div id="imagecontent" class="content">
        <div style="margin-top: 25px;min-height: 150px;min-width: 150px">
