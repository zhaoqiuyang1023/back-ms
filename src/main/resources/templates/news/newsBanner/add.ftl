...
<form class="layui-form" action="" lay-filter="example">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
           <img style="width: 40%;height: 40%"  id="image">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="title" class="layui-input" type="text" placeholder="图片标题" required lay-verify="required"
                   autocomplete="off" value="${newType.value}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="link" class="layui-input" type="text" placeholder="图片链接"
                   autocomplete="off" value="${newType.value}">
        </div>
    </div>
