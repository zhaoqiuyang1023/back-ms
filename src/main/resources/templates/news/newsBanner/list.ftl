    ...
    layui.use(['layer', 'laytpl', 'jquery', 'form', 'table', 'laydate', 'element'], function () {
        ...
        $("#addNews").on("click", function () {
            var addeditIndex = layer.open({
                ...
                type: 2,
                area: ['1920px', '1080px'],
                content: "${base}/newsSet/insert/newsBanner",
                success: function () {
        ...
        table.on('tool(newsTable)', function (obj) {
            ...
            if (obj.event === 'edit') {
                var editIndex = layer.open({
                    ...
                    type: 2,
                    area: ['1920px', '1080px'],
                    content: "${base}/newsSet/update/newsBanner/" + data.id,
        ...
        var t = {
            ...
            cols: [[
                {field: 'imageBannerTitle', title: '图片标题', align: 'left', width: '30%'},
                {field: 'link', title: '链接', width: '30%'},
        ...
        var active = {
            assNews: function () {
                var addIndex = layer.open({
                    title: "添加新闻图片信息",
                    type: 2,
                    content: "/newsSet/insert/newsBanner",
