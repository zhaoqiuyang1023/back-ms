...
<form class="layui-form" action="" lay-filter="example">
    ...
    <input name="id" value="${newType.id}" class="layui-input" type="text" placeholder="请输入标题" autocomplete="off"
           lay-verify="title" style="display: none">
    <input name="name" value="${newType.name}" class="layui-input" type="text" placeholder="请输入标题" autocomplete="off"
           lay-verify="title" style="display: none">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="title" class="layui-input" type="text" placeholder="图片标题" autocomplete="off" required  lay-verify="required"
            value=""
            >
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input name="enLargerImg"  disabled class="layui-input param" placeholder="图片名称" type="text"  autocomplete="off" required  lay-verify="required"
                   value=""
            >
        </div>
        <div class="layui-input-inline">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input name="enSmallImg"  disabled class="layui-input param" type="text" placeholder="图片名称" required  lay-verify="required" autocomplete="off"
                   value=""
                   >
        </div>
        <div class="layui-input-inline">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input name="cnLargerImg" disabled  class="layui-input param" type="text" placeholder="图片名称" autocomplete="off" required  lay-verify="required"
                   value=""
                   >
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input name="cnSmallImg"  disabled class="layui-input param" type="text" placeholder="图片名称" autocomplete="off" required  lay-verify="required"
                   value=""
                   >
        </div>
        <div class="layui-input-inline">
