...
<form class="layui-form" action="" lay-filter="example">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <img id="image" width="400px" height="400px" src="${partner.imageUrl}"
                 fileStorageName="${partner.fileStorageName}" fileStorageId="${partner.fileStorageId}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="name" class="layui-input" type="text" placeholder="媒体名称" required lay-verify="required"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="website" class="layui-input" type="text" placeholder="链接地址" required lay-verify="required"
                   autocomplete="off" value="${partner.website}"
            >
        </div>
    </div>
